...
const Uses = () => {
  ...
  const [uses, setUses] = useState<UsesProps[]>([]);
  const [loading, setLoading] = useState(false);

  const getUsesData = async () => {
    try {
      const query = '*[_type == "usesData"]';
      setLoading(true);
        ...
        <div className="mt-[5rem] md:mt-[9rem] px-4 md:px-12 w-full">
          <div className="max-w-full md:max-w-5xl flex flex-col gap-6">
            <div className="w-full md:w-[70%]">
              ...
              >
                Software I use, endorse, and highly recommend. Explore
                exceptional tools.
              </h1>
              <div
              ...
              >
                <p>
                  ...
                  stay productive, or buy to fool myself into thinking I’m being
                ...
                uses.map((_el) => (
                  <div className="flex gap-4 px-0 md:px-9" key={_el?._id}>
                    ...
                    <div className="flex-[80%]">
                      ...
                      >
                        <p className="block md:hidden text-sm text-[#33A1FD] font-semibold">
                          | {_el?.softwareName}
                        </p>
                        <p
